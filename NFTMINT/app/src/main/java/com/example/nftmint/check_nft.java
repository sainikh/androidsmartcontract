...
public class check_nft extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_nft);
        ...
        RequestQueue queue = Volley.newRequestQueue(check_nft.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    String courseMode = response.getString("description");
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(check_nft.this, "Fail to get data..", Toast.LENGTH_SHORT).show();
            }
        });
