...
public class display_NFT extends AppCompatActivity {
    private TextView courseNameTV, courseTracksTV, courseBatchTV;
    private ImageView courseIV;
    private ProgressBar loadingPB;
    private CardView courseCV;
    String url = "https://gateway.pinata.cloud/ipfs/QmTZwThG32kva4KRZAuSVcuNWTLD8B8NEjenajUidL8HPW";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_display_nft);
        ...
        RequestQueue queue = Volley.newRequestQueue(display_NFT.this);
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                 ...
                 /*   String courseTracks = response.getString("description");*/
                  ...
                  /*  courseTracksTV.setText(courseTracks);*/
                    ...
                    Toast.makeText(display_NFT.this,""+courseImageURL,Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(display_NFT.this, "Fail to get data..", Toast.LENGTH_SHORT).show();
            }
        });
