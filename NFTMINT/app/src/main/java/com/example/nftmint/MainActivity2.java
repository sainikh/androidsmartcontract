...
public class MainActivity2 extends AppCompatActivity {
    ...
    Button btnSave, btnLoad,download;
    EditText etInput;
    TextView tvLoad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if(isStoragePermissionGranted()){
                    ...
                    if(!fileContent.equals("")){
                        ...
                        Toast.makeText(MainActivity2.this, "Information saved to SD card.", Toast.LENGTH_SHORT).show();
                    }else{
                        // If the Text field is empty show corresponding Toast message
                        Toast.makeText(MainActivity2.this, "Text field can not be empty.", Toast.LENGTH_SHORT).show();
                    }
                }
                /*
                if(!fileContent.equals("")){
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                downloadManager.addCompletedDownload(myExternalFile.getName(), myExternalFile.getName(), true, "application/json",myExternalFile.getAbsolutePath(),myExternalFile.length(),true);
